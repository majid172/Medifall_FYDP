...
if (isset($_REQUEST['view'])) //click view button then show details in assign form 
{
    ...
    $row=$res->fetch_assoc();
        ...
        //delete 
              ...
              $sql = "DELETE FROM organizationdonation WHERE orgID = {$_REQUEST['id']}";
			...
			if (isset($_REQUEST['assign'])) {
                ...
                ?>
                <?php
                $sql="UPDATE organizationdonation SET status = 'Assigned To NGO' WHERE donorID={$_REQUEST['donorID']}";
                $res=$conn->query($sql);
                ?>
                ...
                <form method="POST">
                    <div class="form-group p-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                ...
                                <input type="text" name="id" class="form-control mt-1 mb-2 text-center text-danger"
                                    value="<?php if(isset($_REQUEST['orgID'])) echo $_REQUEST['orgID']; ?>" readonly>
                            </div>

                            <div class="col-sm-10">
                                <label for="name">Organization Donor</label><br>
                                <input type="text" name="name" class="form-control mt-1 mb-2"
                                    value="<?php if(isset($_REQUEST['name'])) echo $row['name']; ?>">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" name="address" class="form-control mt-1 mb-2"
                                    value="<?php if(isset($_REQUEST['address'])) echo $row['location'];?>">
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <a href="organization.php" class="btn btn-warning "><i
